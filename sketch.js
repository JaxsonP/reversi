...
function draw() {//---------------------------------------------------------------------------
  ...
  noStroke();
  fill(200);
  rect(140, 404, 120, 43, 15);//reversi by jaxson
...
function mousePressed(event) {
  ...
  if (mouseOnGame && cellGrid[mousePosX][mousePosY].validMove && !gameOver) {

    cellGrid[mousePosX][mousePosY].val = turn + 1;
    cellGrid[mousePosX][mousePosY].finalizeChoice();
    if (turn == 0) {
